...
<script type="text/javascript">
        	...
        	{
        		location="openmail.jsp?classname=trash&&id="+str;
        	}
        </script>
</head>
<body>
	<div id="main_container">
		...
		<div id="main_content">
			...
			<div class="center_content">
				<div class="center_title_bar" id="first">Trash</div>
				<%
              	 		 int i=17;
                    %>
				...
				<% 
                  ...
                  if(userid!=null)
                  {
                      ...
                      String sql="SELECT * FROM email WHERE fromemail='" + userid + "' AND trash='Yes' ORDER BY DateTime DESC";
              ...
              %>
				...
				<%
               		...
               		int count=i;
                %>
				<input type="hidden" id="trash" class="pagename" /> <input
