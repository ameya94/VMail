...
<html>
    <head>
        ...
        <title>Voice Based Email</title>
        	...
        	{
        		location="openmail.jsp?classname=allmail&&id="+str;
        	}
        </script>
    </head>
    <body>
         ...
         <div id="main_container">
            ...
            <div id="main_content">
              ...
              <div class="center_content">
                    <div class="center_title_bar" id="first">All Mails</div>
                    <%
              	 		 int i=17;
                    %>
                  ...
                  if(userid!=null)
                  {
                      ...
                      String sql="SELECT * FROM email WHERE fromemail='" + userid + "' AND trash='No'  ORDER BY DateTime DESC";
                      ...
                      while(rs.next())
                      {
                    	  ...
                    	  {
                %>
                  <div class="prod_box_big" tabindex="<%=i %>" onmouseover="read();" onclick="openfile(<%=id%>)" id="open<%=i%>" tabindex="<%=i%>">
              ...
              <% 
                    	  ...
                    	  {
              %>
              	<div class="prod_box_big1" tabindex="<%=i %>" onclick="openfile(<%=id%>)" id="open<%=i%>" tabindex="<%=i%>">
              	<input type="hidden" id="id" value="<%=id%>">
              ...
              <%
               		...
               		int count=i;
               %>  
               <input type="hidden" id="allmail" class="pagename"/>  
